...
namespace Strings
{
    public static class UsingRanges
    {
        ...
        {
            regionCode = productionCode[..^(productionCode.Length - 1)];
            locationCode = productionCode[3..^(productionCode.Length - 5)];
            dateCode = productionCode[7..^6];
            factoryCode = productionCode[(productionCode.Length - 4) ..];
        }
